...
description: "Reference for background fills, borders, rounding, shadows, backdrop blur, 2D transforms, state-driven styles, transitions, and images on ElementBuilder."
---
...
<ParamField path="setupUniforms" type="Action<Quill.ShaderUniforms>?" default="null">
