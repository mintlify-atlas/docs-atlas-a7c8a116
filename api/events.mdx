...
description: "Complete reference for all Prowl.Paper event types — ClickEvent, DragEvent, ElementEvent, FocusEvent, KeyEvent, ScrollEvent, TextInputEvent, and the PaperKey enum."
---
...
public enum PaperKey
{
    ...
    KeypadEnter, KeypadEquals, KeypadDecimal,
