...
sidebarTitle: "Easing"
description: "Full reference for the static Easing class — all 35 built-in easing functions for Prowl.Paper transitions and animations, with usage examples."
---
