---
title: "Integrating a Custom Renderer Backend for Paper"
sidebarTitle: "Custom Renderer"
description: "Implement ICanvasRenderer to connect Paper's vector drawing pipeline to any graphics API — OpenGL, DirectX, WebGL, Vulkan, Unity, or a game engine's own renderer."
---
...
public class SkeletonRenderer : ICanvasRenderer
{
    ...
    {
        // TODO: compile shader, create VAO/VBO, create default white 1×1 texture
    ...
    {
        // TODO: rebuild orthographic projection matrix: (0,w)×(0,h)
    }
    ...
    public object CreateTexture(uint width, uint height)
    {
        // TODO: return a GPU texture handle
        throw new NotImplementedException();
    }

    public Int2 GetTextureSize(object texture)
    {
        // TODO: return (width, height) of the texture
        throw new NotImplementedException();
    }

    public void SetTextureData(object texture, IntRect bounds, byte[] data)
    {
        // TODO: upload RGBA pixel data into the texture region
        throw new NotImplementedException();
    }
