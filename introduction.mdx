...
<CardGroup cols={2}>
  <Card title="Layout System" icon="table-columns" href="https://github.com/ProwlEngine/Prowl.Paper">
  ...
  <Card title="Animation" icon="film" href="https://github.com/ProwlEngine/Prowl.Paper">
  ...
  <Card title="State Styles" icon="palette" href="https://github.com/ProwlEngine/Prowl.Paper">
  ...
  <Card title="Vector Graphics" icon="pen-nib" href="https://github.com/ProwlEngine/Prowl.Paper">
  ...
  <Card title="Text Rendering" icon="font" href="https://github.com/ProwlEngine/Prowl.Paper">
  ...
  <Card title="Renderer Integration" icon="plug" href="https://github.com/ProwlEngine/Prowl.Paper">
